...
$.extend($.validator, {
	...
	messages: {
		...
		remote: "Prosze poprawic to pole.",
		email: "Prosze wpisac poprawny adres e-mail",
		url: "Please enter a valid URL.",
		date: "Prosze wpisac poprawna date",
		dateISO: "Please enter a valid date (ISO).",
		number: "Prosze wpisac poprawny numer",
		digits: "Please enter only digits.",
		creditcard: "Please enter a valid credit card number.",
		equalTo: "Please enter the same value again.",
		accept: "Please enter a value with a valid extension.",
		maxlength: $.validator.format("To pole musi miec wiecej niz {0} znakow."),
		minlength: $.validator.format("To pole musi miec wiecej niz {0} znakow"),
